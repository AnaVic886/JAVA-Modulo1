...
public class PlaneacionEducativa {
    public static void main(String[] args) {
        ...
        temas.add(new Tema("Taller de Lectura", 2));
        temas.add(new Tema("Matemáticas Operaciones Basicas", 1));
        ...
        recursos.put("Taller de Lectura", "https://recursos.edu/tallerlectura");
        recursos.put("Matemáticas Operaciones básicas", "https://recursos.edu/mate");
        recursos.put("Ciencias Naturales", "https://recursos.edu/cienciasn");
